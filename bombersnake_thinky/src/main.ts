...
const GRAYSCALE = {
  WEB_BG: "#83c253;",
  BORDER: "#8ccbf2",
  BACKGROUND: "rgb(45,65,90)",
  BACKGROUND_2: "rgb(50,70,90)",
  BACKGROUND_3: "rgb(40,55,80)",
  BOMB: "#555555",
  TEXT: "#f4f4f4",
  GRAY_TEXT: "#b4b4b4",
  SNAKE_HEAD: 'rgb(40,60,60)',
  SNAKE_WALL: 'rgb(35,55,60)',
  //SNAKE_WALL2: '#686868',
  EXPLOSION: "#D4D4D4",
  MULTIPLIER: "#f4f4f4",
  GRIDLINE: "#2f324b",
  ...
  if (game_state === "loading_menu") {
    ...
    if (input.mouse.wasPressed(MouseButton.Left)) {
      ...
      if (initial_song !== null && !initial_song.playing()) {
        ...
        initial_song.volume(0);
        // setTimeout(() => initial_song.fade(0, original_volume, 1200), 2000);
        initial_song.fade(0, original_volume / 12, 400)
        setTimeout(() => initial_song.fade(0, original_volume, 2800), 1000);
        // }, 200);
    ...
    if (game_state === 'playing') {
      // start game
      started_at_timestamp = last_timestamp;
      randomChoice(MAPS).forEachV((p, b) => {
        if (b !== null) {
          turn_state.addInitialObstacleAt(p, b.in_dir, b.out_dir);
        }
      })
